function sres = gw_fullfreq_cd_res(ksinfo, options)
...
if flagry2ev
  ksinfo.ev = ksinfo.ev * ry2ev;
  ksinfo.Vxc = ksinfo.Vxc * ry2ev;
...
[grid_real, coeff_real_func, grid_imag, coeff_imag_func] = freqgen(ksinfo, options);
