...
dtype_list = {'double', 'double', 'cdouble', 'csingle'};
...
fprintf('dtype_list = [double, double, cdouble, csingle]\n');
...
switch dtype
  ...
  case 'csingle'
    X = complex(rand(m, n, 'double'), rand(m, n, 'double'));
  otherwise
