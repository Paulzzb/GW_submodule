...
%
%   isdf.adaptive_double.run_adaptiveisdf('nn', output_dir)
%   isdf.adaptive_double.run_adaptiveisdf('vn', output_dir)
%
% Inputs:
...
%   test_relay_stage.mat (e.g. test_Si), then call isdf.adaptive_double.run_adaptiveisdf(...).
%
...
% validation uses that directory as pwd for report generation.
  ...
  cd(output_dir);
  isdf.adaptive_double.adaptiveisdf(id_slot, cfg);
