...
%
%   fpath = isdf.adaptive_double.adaptive_checkpoint_path(coarse_id)
%   fpath = isdf.adaptive_double.adaptive_checkpoint_path(coarse_id, desc)
%
...
% (Legacy name isdf_adaptive_checkpoint_id<coarse_id>.mat is read-only fallback in try_load.)
  ...
  root = isdf.adaptive_double.adaptive_checkpoint_storage_root();
