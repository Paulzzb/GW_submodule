...
%   trunc = inv_param, ratio = inv_ratio.
  ...
  for iqibz = 1:nibz
    ...
    isdf_data.helperqG(:, 1:l_keep, iqibz) = helperqG(:, 1:l_keep);
    tildeVq(1:l_keep, 1:l_keep, iqibz) = helperqG(:, 1:l_keep)' * diag(vcoul_q) * helperqG(:, 1:l_keep);
    tildeVq(1:l_keep, 1:l_keep, iqibz) = tildeVq(1:l_keep, 1:l_keep, iqibz)*0.5 + tildeVq(1:l_keep, 1:l_keep, iqibz)' *0.5;
  end % iqibz
