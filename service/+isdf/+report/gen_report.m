...
% isdf.report.gen_report  Write HF validation text report produced by isdf_validate_HF to a file.
%
%   fpath = isdf.report.gen_report(report)
%   fpath = isdf.report.gen_report(report, outDir)   % optional directory (default: pwd)
%
