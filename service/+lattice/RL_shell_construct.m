...
%    and first_index_of_each_shell in `r_lattice_m'. 
  ...
  r_lat_m.Ggrid_Cart = double(r_lat_m.Ggrid_RLU) * b1b2b3';
  ...
  for irot = 1:symm_m.nsym 
    ...
    rot_Ggrid_RLU = int32( double( r_lat_m.Ggrid_RLU(:, :) ) * mtrx_RLU );
