...
%   cols = isdftest.adaptive.MrC1H('cached_cols', row_idx)
%   isdftest.adaptive.MrC1H('set_range', row_idx, cstart, vals)
%   blk = isdftest.adaptive.MrC1H('get', row_idx, cstart, cend)
%   isdftest.adaptive.MrC1H('set_cached_cols', row_idx, ncols)
