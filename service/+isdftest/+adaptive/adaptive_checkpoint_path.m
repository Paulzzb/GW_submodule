...
%
%   fpath = isdftest.adaptive.adaptive_checkpoint_path(coarse_id)
%   fpath = isdftest.adaptive.adaptive_checkpoint_path(coarse_id, desc)
%
...
% (Legacy name isdf_adaptive_checkpoint_id<coarse_id>.mat is read-only fallback in try_load.)
  ...
  root = isdftest.adaptive.adaptive_checkpoint_storage_root();
