...
%
%   isdftest.adaptive.adaptive_checkpoint_save(coarse_id, id_adaptive)
%
% Saves isdf_data, id_coarse, id_adaptive, and isdf_desc (vc/vn/nn of coarse slot).
  ...
  fpath = isdftest.adaptive.adaptive_checkpoint_path(coarse_id, isdf_desc);
  isdf_data = isdftest.get(id_adaptive);
  id_coarse = coarse_id;
