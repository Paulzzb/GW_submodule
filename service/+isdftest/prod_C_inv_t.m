...
%
%   l_keep = isdftest.prod_C_inv_t('set', CCHq)
%   l_keep = isdftest.prod_C_inv_t('set', CCHq, trunc)
%   l_keep = isdftest.prod_C_inv_t('set', CCHq, trunc, ratio)
%   isdftest.prod_C_inv_t('set_factors', V_trunc, Lambda_trunc, ratio)
%   [V_trunc, Lambda_trunc, l_keep, ratio] = isdftest.prod_C_inv_t('get_factors')
%   Y = isdftest.prod_C_inv_t('prod', 'r', A)   % A * V_trunc * Lambda_trunc^{ratio-1} (padded to N columns)
%   Y = isdftest.prod_C_inv_t('prod', 'l', A)   % Lambda_trunc^{-ratio} * V_trunc' * A (padded to N rows)
%   [L_full, R_full] = isdftest.prod_C_inv_t('assemble')
