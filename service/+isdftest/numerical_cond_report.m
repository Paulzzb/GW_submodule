...
%   isdftest.numerical_cond_report('adaptive', coarse_id, idnew, desc, loss_before_step1, loss_after, final_nisdf)
%   isdftest.numerical_cond_report('gen_tildevq_begin', id, desc, s_cut)
...
function local_write_init()
  ...
  oc = onCleanup(@() fclose(fid)); %#ok<NASGU>
  fprintf(fid, '=== isdftest numerical_cond_report ===\n');
