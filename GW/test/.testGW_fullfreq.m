...
% options_input.frequency_dependence      = 0; 
...
% options_input.nv_oper       = 4;
% options_input.nc_oper       = 4;
...
options_input.delta_frequency = 5.0;
...
profile on
sintISDF = gw_fullfreq_cd_int_ISDF(ksinfor, options)
