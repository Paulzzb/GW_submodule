function [grid_real, coeff_real_func, grid_imag, coeff_imag_func] = freqgen(ksinfo, options, method_real, method_imag)
% Description
%     Generate frequency grid for GW calculation.
%     called in function gw_fullfreq*
% Input
%     ksinfo: class ksinfo, calculated from ground-state method.
