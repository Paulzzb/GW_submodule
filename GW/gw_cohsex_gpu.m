function gw_cohsex_gpu(ksinfo, options)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     fftbox1 = do_FFT(fftbox1, gvec.fftgrid, 1) * ksinfo.vol;
%     tmpssrzetamu = reshape(fft?box1, gvec.nfftgridpts, []);
...
%   W1_     = (inveps + eye(ng) * Dcoul;
  ...
  for ioper = nv-nv_oper+1:nv
    ...
    Mgvn = conj(Mgvn);
    W1Mgvn = Dcoul * Mgvn;
    Ex = Ex + Mgvn' * W1Mgvn / ksinfo.vol;

    W1Mgvn = inveps \ W1Mgvn;
    W1Mgvn = W1Mgvn - Dcoul * Mgvn;
    Esx_x = Esx_x + Mgvn' * W1Mgvn / ksinfo.vol;
    Ech = Ech + Mgvn' * W1Mgvn / ksinfo.vol;
  end
  clear Mgvn W1Mgvn;
  for ioper = nv+1:nv+nc_oper
    ...
    Ech = Ech + Mgcn' * W1Mgcn / ksinfo.vol;
  end
  clear W1Mgcn Mgcn;
