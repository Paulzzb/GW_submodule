...
classdef symm_m
  properties
    ...
    rot_mtrx_RLU_G  (3, 3, :) = 0  % 3x3xnsym
    rot_mtrx_RLU_R  (3, 3, :) = 0  % 3x3xnsym
    rot_mtrx_Cart   (3, 3, :) = 0  % 3x3xnsym
  ...
  methods
    ...
    % function obj = symm_m(ob)
      ...
      obj.nsym = int32( nsym );
      obj.nrot = int32( nrot );
      obj.rot_mtrx_RLU_G = int32( zeros(3, 3, nsym) ); 
      obj.rot_mtrx_RLU_R = int32( zeros(3, 3, nsym) ); 
      obj.rot_mtrx_Cart  = int32( zeros(3, 3, nsym) ); 
