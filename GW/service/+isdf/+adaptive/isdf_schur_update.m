...
%   isdf_schur_update('clear')
  ...
  switch lower(mode)
    case 'update'
      ...
      % C1C2H = isdf.adaptive.isdf_prod(Psi_on_grid(1:Nisdf, :), Psi_on_new_grid, Phi_on_grid(1:Nisdf, :), Phi_on_new_grid); 
      C2C1H = isdf.prod(Psi_on_new_grid, Psi_on_grid(1:Nisdf, :), Phi_on_new_grid, Phi_on_grid(1:Nisdf, :)); 
      ...
      = isdf.prod(Psi_on_grid(1:Nisdf, :), Psi_on_new_grid, Phi_on_grid(1:Nisdf, :), Phi_on_new_grid); 
