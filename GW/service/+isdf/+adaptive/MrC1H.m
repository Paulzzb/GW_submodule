...
%   cols = isdf.adaptive.MrC1H('cached_cols', row_idx)
%   isdf.adaptive.MrC1H('set_range', row_idx, cstart, vals)
%   blk = isdf.adaptive.MrC1H('get', row_idx, cstart, cend)
%   isdf.adaptive.MrC1H('set_cached_cols', row_idx, ncols)
